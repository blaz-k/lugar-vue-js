  ...
  <div id="footer-section" class="container">
    <footer class="row py-5 my-5 border-top">
      <div class="col">
        ...
        <div>
          <p>
            <i class="fas fa-map-marker-alt"></i>2118 Thornridge Cir. Dubai, UAE
            35624
          </p>
          <p><i class="fas fa-phone-alt"> </i> +33 415 65356 - 9</p>
          <p><i class="fas fa-envelope"></i>contact@lugar.com</p>
        </div>
      ...
      <div class="col">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2">
            <a href="#" class="nav-link p-0 text-muted">Project</a>
          </li>
          <li class="nav-item mb-2">
      ...
      <div class="col">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2">
            <a href="#" class="nav-link p-0 text-muted">Conditions</a>
          </li>
          <li class="nav-item mb-2">
            <a href="#" class="nav-link p-0 text-muted">Policy</a>
          </li>
        </ul>
      </div>
